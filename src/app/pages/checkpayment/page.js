...
const PaymentCheck = () => {
  ...
  const handleBuyNow = async (product) => {
    setProduct(product);
    try {
      const response = await axios.post('https://api.stylishhim.com/api/razorpay', {
      ...
      const options = {
        ...
        handler: async (response) => {
          const paymentResult = await axios.post('https://api.stylishhim.com/api/payment-verification', {
            order_id,
            ...response
          });
